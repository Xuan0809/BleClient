...
public class MainActivity extends Activity {
    ...
    private String BlueECG_ADD = "0C:61:CF:47:1B:85";                                               //Address for BlueECG device
    private String BLEGattLight_NAME = "0C:61:CF:47:1B:85";
    private String mDeviceAddress = "0C:61:CF:47:1B:85";
                ...
                public void onLeScan(final BluetoothDevice device, int rssi,
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Log.e("TAG", "deviceScan :" + deviceScanFound.getName());
                            ...
                            //}
                            if(BLEGattLight_NAME.equals(mDeviceAddress)) {
                                launchConnect(device);
                            }
                        }
                    });
