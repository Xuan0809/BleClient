...
public class SecondActivity extends Activity {
    ...
    public BluetoothGattCharacteristic getCharacteristic2() { return characteristic2; }
    //The characteristic with all the values
    ...
    private final String SERVICE_UUID = "0000ff01-0000-1000-8000-00805f9b34fb";
    public final String CHAR2_UUID = "0000ff0a-0000-1000-8000-00805f9b34fb";
    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
                ...
                Log.e("TAG","GetService :" + mBluetoothLeService.getSupportedGattServices().toString());
            }
        }
    };
